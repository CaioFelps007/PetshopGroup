    ...
    <SafeAreaView>
      ...
      >
        ...
        <View style={styles.formularioLogin}>
          ...
          />
          <TextInput style={styles.caixatextoLogin} placeholder="Email " />
          ...
          >
            <Botao
              ...
              onpresstxt={() => navigation.navigate("Home")}
            />
            <Botao
              TxtBtn={"Crie uma conta !"}
              estilos={{ marginTop: 10 }}
              txtestilos={{
                color: "#17395C",
                fontSize: 15,
                fontWeight: "bold",
